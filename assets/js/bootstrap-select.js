...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    noneResultsText: 'No results matched [$1]',
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? '[$1] item selected' : '[$1] items selected';
    },
      ...
      if (this.options.selectedTextFormat === 'static') {
        ...
        if (showCount === false) {
          ...
          titleFragment = generateOption.text.call(this, {
            text: tr8nText.replace('[$1]', selectedCount.toString()).replace('[$1]', totalCount.toString())
          }, true);
        }
      }
      ...
      this.$searchbox.on('input propertychange', function () {
        ...
        if (searchValue) {
          ...
          if (!searchMatch.length) {
            ...
            noResults.innerHTML = that.options.noneResultsText.replace('[$1]', '"' + htmlEscape(searchValue) + '"');
