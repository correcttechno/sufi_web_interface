    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                <li><span class="text-main-600 fw-normal text-20">Hərəkətlər</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
            ...
            <table id="assignmentTable" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="h6 text-gray-300">Command</th>
                        <th class="h6 text-gray-300">Təkrarlanma</th>
    ...
    <div class="modal-dialog modal-md modal-dialog modal-dialog-centered">
        <div class="modal-content radius-16 bg-base">
            <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Yeni hərəkət yarat</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-24">
                <form action="<?=base_url('actions/add');?>" method="post">
                    <div class="row">
                        <input type="hidden" name="id" value="0"/>
                        <div class="col-6 mb-20">
                            <label class="form-label fw-semibold text-primary-light text-sm mb-8">Başlıq:<span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="col-6 mb-20">
                            <label class="form-label fw-semibold text-primary-light text-sm mb-8">Təkrarlanma:<span class="text-danger">*</span>
                            </label>
                            <input type="text" name="rep" class="form-control radius-8" placeholder="Təkrarlanma" value="1">
                            
                            <span data-error="rep" class="text-xs text-danger"></span>
                        </div>
...
<?php $this->modal_model->delete("actions");?>
<?php endif;?>